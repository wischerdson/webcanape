...
$router->add('company/{company_id}/delete', [ CompanyController::class, 'delete' ]);
...
$router->add('company/{company_id}/reviews/{review_id}/publish', [ ReviewController::class, 'publish' ]);
$router->add('company/{company_id}/reviews/{review_id}/delete', [ ReviewController::class, 'delete' ]);
